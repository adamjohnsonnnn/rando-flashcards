...
nineties_deck = Deck.create!(name: "Nineties", description: "So much for Reddit nostalgia about the 90's", creator: creator)

nineties_first_card = Card.create!(question: "66 percent of what band kissed on SNL. Causing a minor controversy.", answer: "nirvana", deck: nineties_deck)
nineties_second_card = Card.create!(question: "Are those tiddleywinks? No, those are...", answer: "pogs", deck: nineties_deck)

nineties_third_card = Card.create!(question: "What single letter caused the nation to mock the Vice President?", answer: "e", deck: nineties_deck)

nineties_fourth_card = Card.create!(question: "In response to a failed assassination plot what country did Bill Clinton authorize the bombing of?", answer: "iraq", deck: nineties_deck)

nineties_fifth_card = Card.create!(question: "What computer company made headlines with the introduction of their colorful line of internet ready computers?", answer: "apple", deck: nineties_deck)
...
punchlines_second_card = Card.create!(question: "What did Jay-Z call his girlfriend before they got married?", answer: "Feyonce", deck: punchlines_deck)
  ...
  punchlines_third_card = Card.create!(question: "What do you call a dinosaur with a extensive vocabulary?", answer: "thesaurus", deck:punchlines_deck)
